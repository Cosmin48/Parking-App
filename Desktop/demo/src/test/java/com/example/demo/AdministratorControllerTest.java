...
class AdministratorControllerTest extends AdministratorController {
    private Parent root;
    private Stage stage;
    private Scene scene;
    @FXML
    ...
    public void acceptButtonOnAction(ActionEvent event) throws SQLException {
        ...
        ps.executeUpdate();
        String querry="CREATE TABLE IF NOT EXISTS "+list.get(index).getUsername()+"(id int NOT NULL UNIQUE AUTO_INCREMENT, area VARCHAR(45) NOT NULL UNIQUE, price int NOT NULL, PRIMARY KEY(id))";
    ...
    @Test
    void acceptButtonOnAction() {
    }

    @Test
    void denyButtonOnAction() {
    }
}