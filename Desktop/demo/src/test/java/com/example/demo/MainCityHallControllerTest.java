...
class MainCityHallControllerTest extends MainCityHallController {
    private Parent root;
    private Stage stage;
    private Scene scene;
    @FXML
    ...
    @Test
    void switchToSeeRating() {
    }

    @Test
    void switchToviewHistory() {
    }

    @Test
    void switchToviewHistory1() {
    }
